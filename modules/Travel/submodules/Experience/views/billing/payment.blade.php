                                ...
                                <div class=" mt-4">
                                    <form action="{{ route('shop.payment.paypal') }}" method="POST">
                                        ...
                                        @foreach ($items as $k => $item)
                                            <input type="hidden" name="items[{{ $i }}][amount]" value="{{ $item->price }}"><br>
                                            <input type="hidden" name="items[{{ $i }}][quantity]" value="{{ $item->quantity }}"><br>
                                            <input type="hidden" name="items[{{ $i }}][name]" value="{{ $item->name }}"><br>
                                            @php
                                                $i++;
                                            @endphp
                                        @endforeach
                        ...
                        <v-card class="elevation-1 mb-3">
                            ...
                            <v-card-text>
                                <div class="subheading grey--text text--darken-2">
                                    You have 42 hours to pay from the time of booking to pay for this reservation through PayPal/BPI. You will receive a confirmation email <strong>({{ user()->email }})</strong> once payment is made.
                                </div>
                            </v-card-text>
                        </v-card>
