<v-card class="elevation-1 mb-3">
    ...
    <v-card-text class="grey lighten-4">
        <div v-if="! resource.dates.items.length">
            ...
            <span class="caption red--text" v-if="errors[`category`]" v-html="errors[`category`].join(',')"></span>
        </div>

        <input type="hidden" name="category_obj" :value="JSON.stringify(resource.dates.items)">
        ...
        <v-card v-for="(date, i) in resource.dates.items" :key="i" class="elevation-1 mb-2">
            ...
            <input type="hidden" :name="`category[${i}][id]`" :value="date.id">
            <v-card-text v-if="date.start">
                <v-menu
                    ...
                    <v-text-field
                        slot="activator"
                        :name="`category[${i}][date_start]`"
                        :error-messages="errors[`category.${i}.date_start`]"
                        label="{{ __('Start Date') }}"
                ...
                <v-menu
                    ...
                    <v-text-field
                        slot="activator"
                        :name="`category[${i}][date_end]`"
                        :error-messages="errors[`category.${i}.date_end`]"
                        label="{{ __('End Date') }}"
