                        ...
                        <v-card class="elevation-0 transparent" height="400px">
                            <v-card-text class="text-xs-center my-3">
                                ...
                                <h2 class="subheading grey--text">
                                    {{ __("No Packups found with those parameters.") }}
                                </h2>
                                <v-btn large href="{{ route('packups.create') }}" class="primary subheading">{{ __('Create New Packup') }}</v-btn>
                            </v-card-text>
                        </v-card>
                    </v-flex>
                </v-layout>
                ...
                <v-layout row wrap align-center justify-center>
                    <v-flex lg10 xs12>
                        ...
                        <v-layout row wrap align-center>
                            <v-flex xs12 sm4 md3 v-for="(card, key) in packups.data" :key="key">
                                        ...
                                        <v-card-media
                                            ...
                                            <div class="text-xs-right" style="width: 100%;">
                                                <v-btn large v-tooltip:left="{ html: '{{ __('Add to wishlist') }}' }" icon class="mr-3">
                                                    @include("Packup::components.wishlist")
                                                </v-btn>
                        ...
                        <v-card-text>
                            <div class="text-xs-center">
                                ...
                                {{-- <v-pagination circle :length="packups.length" v-model="page" :total-visible="8" class="caption main-paginate"></v-pagination> --}}
                            </div>
                        </v-card-text>
                    </v-flex>
                </v-layout>
        ...
        mixins.push({
            data () {
                return {
                    ...
                    menu: false,
                    page: 1,
                    packups: {!! json_encode($resources->toArray()) !!},
                }
            },
            mounted () {
