                ...
                <v-card class="elevation-1 mb-3">
                    ...
                    <v-list subheader class="py-0 hidden-md-and-up">
                        ...
                        <v-list-tile avatar ripple href="\faq">
                            ...
                            <v-list-tile-content>
                                <v-list-tile-title>Packup Philippines</v-list-tile-title>
                ...
                <div class="stickybar">
                    <v-card class="elevation-1 mb-3">
                        ...
                        <v-card-actions>
                            ...
                            <v-spacer></v-spacer>
                            <v-btn icon v-tooltip:left="{ 'html': 'Edit Packup' }" href="{{ route('packups.edit', $resource->id) }}">
                                <v-icon>edit</v-icon>
                            </v-btn>
                        </v-card-actions>
                        @endcan
                    ...
                    <v-card class="elevation-1 mb-3">
                        <v-list subheader class="py-0">
                            ...
                            <v-list-tile avatar ripple href="{{ route('public.show', 'faq') }}">
                                ...
                                <v-list-tile-content>
                                    <v-list-tile-title>{{ __('Packup Philippines') }}</v-list-tile-title>
            ...
            <v-flex xs12>
                <v-card-actions>
                            ...
                            <v-card>
                                ...
                                <v-card-media src="{{ assets('frontier/images/placeholder/red2.jpg') }}">
                                    ...
                                    <v-card-text class="text-xs-center">
                                        ...
                                        {{-- <div class="text-xs-center">
                                            <v-btn primary large round class="elevation-1 px-4" href="{{ route('packups.details', $resource->code) }}">Packup Now</v-btn>
                                        </div> --}}
                                    </v-card-text>
                                </v-card-media>
                                <v-list two-line>
                   ...
                   {{--  <v-card-text class="px-0 py-2 text-xs-right">
                        <v-btn large primary round class="elevation-1 px-2" href="{{ route('packups.details', $resource->code) }}">Packup Now</v-btn>
                    </v-card-text> --}}
                </v-card-actions>
            </v-flex>
        </v-layout>
