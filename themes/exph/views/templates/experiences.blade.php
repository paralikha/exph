...
--}}
@php
    $resources = \Experience\Models\Experience::paginate();
    if (null !== \Illuminate\Support\Facades\Request::get('date_from') && null !== \Illuminate\Support\Facades\Request::get('date_to')) {
        $resources = \Experience\Models\Experience::whereBetween('date_start', [\Illuminate\Support\Facades\Request::get('date_from'), \Illuminate\Support\Facades\Request::get('date_to')])->paginate();
    }
@endphp
